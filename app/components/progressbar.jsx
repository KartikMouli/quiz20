            ...
            {questions.map((_, index) => (
                <div key={index} className="flex items-center">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <span className={`px-3 text-xs font-semibold ${index === currentQuestionIndex ? "text-green-500" : statuses[index] === 'solved'
                            ? 'text-blue-500' : statuses[index] === 'skipped'
                                ? 'text-yellow-500' // Show yellow if the question is skipped
                                : 'text-gray-300'}`}>{index + 1}</span>
                    </div>
