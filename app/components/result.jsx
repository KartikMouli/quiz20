  ...
  return (
    <div className="fixed inset-0 z-50 min-h-screen flex flex-col bg-white p-4">
      ...
      <div className="w-full space-y-2 mt-auto">
        <button className="flex items-center justify-center bg-[#ff0a54] text-white py-4 rounded-lg font-semibold w-full gap-2">
          LEADERBOARD <MdLeaderboard size={24} />
        </button>

        <div className="flex gap-2 w-full">
          <button className="flex items-center justify-center py-4 w-full sm:w-1/2 bg-[#252526] rounded-xl text-gray-100 font-semibold gap-2">
