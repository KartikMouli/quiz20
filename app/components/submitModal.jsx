...
function SubmitModal({ isOpen, onClose, unattemptedQuestion }) {
    if (!isOpen) return null;

    return (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-3xl p-5 shadow-md w-96 md:w-fit">
                <h1 className='text-2xl text-red-500 font-bold mb-4'>Submit Quiz</h1>
                <h3 className='mb-3'>Unattempted question : <span className='font-bold'>{unattemptedQuestion}</span></h3>
                ...
                <div className='flex justify-end space-x-2'>
                    <button className="px-5 py-1 bg-gray-300 text-sm md:text-md text-purple-500 rounded-full">Yes</button>
